...
public class PrinterService {
    ...
    public static void Print(InfoConserned infoConserned) throws Exception{
        ...
        String numeroPdf = String.valueOf(infoConserned.getActeNaissance());
        ...
        canvas.showText(numeroPdf.strip());
    ...
    public static void main(String[] args) throws Exception {
        InfoConserned infoConserned = Persistence.createEntityManagerFactory("Bulletin").createEntityManager().find(InfoConserned.class,1);
        Print(infoConserned);
    }
}
